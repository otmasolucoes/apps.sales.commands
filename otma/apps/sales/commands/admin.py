...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('id', 'command', 'product', 'product_image', 'product_name', 'product_price', 'quantity', 'total', 'status', 'checkin_time', 'expected_duration', 'expected_time', 'checkout_time', 'waiting_time','implement_time', 'closed_time', 'duration_time', 'observations')
    ordering = ('id',)
