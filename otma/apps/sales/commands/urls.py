...
from otma.apps.sales.commands.api import TableController, \
    CommandController, OrderController, MenuGroupController, MenuProductController, DatabaseController
